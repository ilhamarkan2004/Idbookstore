                ...
                <div class="p-6 text-gray-900">
                    <div class="p-8 rounded">
                        ...
                        <form method="POST" action="{{ route('buku.store') }}" enctype="multipart/form-data">
                            ...
                            <div>
                                <label for="tipe"
                                    class="text-sm text-gray-700 block mb-1 mt-4 font-medium">Tipe</label>
                                <select name="tipe"
                                    class="form-select appearance-none block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
                                    aria-label="Default select example">
                            ...
                            <div>
                                ...
                                <input type="text" name="flipbook" id="flipbook"
                                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
                                    placeholder="URL Flipbook" value=" {{ old('flipbook') }}" />
                                @error('flipbook')
                                <p class="text-red-500 mt-2">{{$message}}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" name="isbn" id="isbn"
                                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
                                    placeholder="Nomor ISBN" value=" {{ old('isbn') }}" />
                                @error('isbn')
                                <p class="text-red-500 mt-2">{{$message}}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" name="berat" id="berat"
                                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
                                    placeholder="Berat Buku" value=" {{ old('berat') }}" />
                                @error('berat')
                                <p class="text-red-500 mt-2">{{$message}}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" name="lebar" id="lebar"
                                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
                                    placeholder="Lebar Buku" value=" {{ old('lebar') }}" />
                                @error('lebar')
                                <p class="text-red-500 mt-2">{{$message}}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="number" name="panjang" id="panjang"
                                    class="bg-gray-100 border border-gray-200 rounded py-1 px-3 block focus:ring-blue-500 focus:border-blue-500 text-gray-700 w-full"
                                    placeholder="Panjang Buku" value="  {{ old('panjang') }}" />
                                @error('panjang')
                                <p class="text-red-500 mt-2">{{$message}}</p>
                                @enderror
                            </div>
