            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="p-8 rounded ">
                        ...
                        <p class="text-gray-600 mt-6">Jika ingin menambahkan Kontributor baru, maka isilah beberapa form
                            di
                            bawah ini</p>
                        <form method="POST" action="{{ route('kontributor.store') }}">
                            @csrf
                            <div class="mt-8 grid lg:grid-cols-2 gap-4">
                                <div> <label for="nama"
                                        ...
                                        placeholder="Nama Kontributor" value="{{ old('nama') }}" />
                                </div>
                            </div>
                            <div>
                                <label for="buku_id"
